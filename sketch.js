...
function setup() {
 ...
 ground=createSprite(width/2,height/2,width*4,50)
 inground=createSprite(width/2,height-40,width*4,1)
 ground.addImage(bg)
// ground.velocityX=-3
...
restart = createSprite(width/2,290);
